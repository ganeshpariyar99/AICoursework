        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-desc">
              Your one-stop destination for the latest electronic gadgets in Nepal. 
          ...
          <div>
            ...
            <div className="footer-contact-item">
              ...
              <span>support@egadgethive.com</span>
            </div>
          </div>
        </div>

        <div className="footer-bottom">
          <p>&copy; 2025 E-GadgetHive. All rights reserved. Final Year Project.</p>
        </div>
      </div>
    </footer>
  );
